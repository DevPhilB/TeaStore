...
public final class OrderItemRepository extends AbstractPersistenceRepository<OrderItem, PersistenceOrderItem> {
	...
	public long createEntity(OrderItem entity) {
		...
		item.setUnitPriceInCents(entity.unitPriceInCents());
		EntityManager em = getEM();
	    try {
	        em.getTransaction().begin();
	        PersistenceProduct prod = em.find(PersistenceProduct.class, entity.productId());
	        PersistenceOrder order = em.find(PersistenceOrder.class, entity.orderId());
