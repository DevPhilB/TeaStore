...
/**
 * HTTP/2 server handler for recommender service
 * @author Philipp Backes
 */
public class Http2RecommenderServiceHandler extends ChannelDuplexHandler {
    ...
    public Http2RecommenderServiceHandler(String gatewayHost, Integer gatewayPort) {
        api = new RecommenderAPI("HTTP/2", gatewayHost, gatewayPort);
    }
